...
public class UserRestControllerCategoriesTest extends BudgeezBootApplicationTests {

    private String name = "User Categories";
    private String email1 = "usercategories1@budgeez.com";
    private String email2 = "usercategories2@budgeez.com";
